...
CREATE TABLE "sadnje" (
    ...
    "parcelaId" INTEGER NOT NULL,
    "biljkaId" INTEGER,
    "nazivKulture" TEXT NOT NULL,
    "vrstaKulture" "VrstaBiljke" NOT NULL,
...
-- CreateTable
CREATE TABLE "chat_kontakti" (
    "id" SERIAL NOT NULL,
    "korisnik1Id" INTEGER NOT NULL,
    "korisnik2Id" INTEGER NOT NULL,
    "kreiranDana" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "chat_kontakti_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "chat_poruke" (
    "id" SERIAL NOT NULL,
    "posiljalacId" INTEGER NOT NULL,
    "primalacId" INTEGER NOT NULL,
    "sadrzaj" TEXT NOT NULL,
    "datumSlanja" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "procitano" BOOLEAN NOT NULL DEFAULT false,

    CONSTRAINT "chat_poruke_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "chat_kontakti_korisnik1Id_idx" ON "chat_kontakti"("korisnik1Id");

-- CreateIndex
CREATE INDEX "chat_kontakti_korisnik2Id_idx" ON "chat_kontakti"("korisnik2Id");

-- CreateIndex
CREATE UNIQUE INDEX "chat_kontakti_korisnik1Id_korisnik2Id_key" ON "chat_kontakti"("korisnik1Id", "korisnik2Id");

-- CreateIndex
CREATE INDEX "chat_poruke_posiljalacId_primalacId_datumSlanja_idx" ON "chat_poruke"("posiljalacId", "primalacId", "datumSlanja");

-- CreateIndex
CREATE INDEX "chat_poruke_primalacId_posiljalacId_datumSlanja_idx" ON "chat_poruke"("primalacId", "posiljalacId", "datumSlanja");
...
-- AddForeignKey
ALTER TABLE "sadnje" ADD CONSTRAINT "sadnje_biljkaId_fkey" FOREIGN KEY ("biljkaId") REFERENCES "biljke"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "chat_kontakti" ADD CONSTRAINT "chat_kontakti_korisnik1Id_fkey" FOREIGN KEY ("korisnik1Id") REFERENCES "poljoprivrednici"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "chat_kontakti" ADD CONSTRAINT "chat_kontakti_korisnik2Id_fkey" FOREIGN KEY ("korisnik2Id") REFERENCES "poljoprivrednici"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "chat_poruke" ADD CONSTRAINT "chat_poruke_posiljalacId_fkey" FOREIGN KEY ("posiljalacId") REFERENCES "poljoprivrednici"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "chat_poruke" ADD CONSTRAINT "chat_poruke_primalacId_fkey" FOREIGN KEY ("primalacId") REFERENCES "poljoprivrednici"("id") ON DELETE CASCADE ON UPDATE CASCADE;
